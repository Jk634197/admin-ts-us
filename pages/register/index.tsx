...
function Register() {
  ...
  const [organization, setOrganization] = useState("");
    ...
    const createAccount = () => {
        ...
        const url = "http://68.178.202.181:8000/api/v1/account/register/";
        let data = {
            user: {
                email: email,
                username: username,
  ...
  return (
    <OverviewWrapper sx={{margin:"auto",maxWidth:"23rem"}}>
      ...
      >
        ...
        <TextField
          ...
          required
        />
        <Button variant="contained" color="primary" sx={{m:2}} onClick={(e)=>{createAccount()}}>
          Register
        </Button>
      </FormControl>
        </Box>
